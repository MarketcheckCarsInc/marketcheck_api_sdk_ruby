...
# Unit tests for Marketcheck_api_sdk::SearchResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SearchResponse' do
  before do
    # run before each test
    @instance = Marketcheck_api_sdk::SearchResponse.new
  end
  ...
  describe 'test an instance of SearchResponse' do
    it 'should create an instance of SearchResponse' do
      expect(@instance).to be_instance_of(Marketcheck_api_sdk::SearchResponse)
    end
  end
