...
# Unit tests for Marketcheck_api_sdk::BaseListing
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BaseListing' do
  before do
    # run before each test
    @instance = Marketcheck_api_sdk::BaseListing.new
  end
  ...
  describe 'test an instance of BaseListing' do
    it 'should create an instance of BaseListing' do
      expect(@instance).to be_instance_of(Marketcheck_api_sdk::BaseListing)
    end
  end
