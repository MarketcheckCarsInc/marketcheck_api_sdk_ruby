...
# Unit tests for Marketcheck_api_sdk::Averages
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Averages' do
  before do
    # run before each test
    @instance = Marketcheck_api_sdk::Averages.new
  end
  ...
  describe 'test an instance of Averages' do
    it 'should create an instance of Averages' do
      expect(@instance).to be_instance_of(Marketcheck_api_sdk::Averages)
    end
  end
