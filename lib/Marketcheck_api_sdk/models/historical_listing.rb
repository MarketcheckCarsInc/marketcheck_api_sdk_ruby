  ...
  class HistoricalListing
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'seller_name_o')
        self.seller_name_o = attributes[:'seller_name_o']
      end
      ...
      if attributes.has_key?(:'dealer_id')
        self.dealer_id = attributes[:'dealer_id']
      end
    ...
    def hash
      [id, heading, vin, price, miles, msrp, data_source, is_certified, is_searchable, vdp_url, carfax_1_owner, carfax_clean_title, exterior_color, interior_color, dom, dom_180, dom_active, seller_type, inventory_type, stock_no, last_seen_at, last_seen_at_date, scraped_at, scraped_at_date, first_seen_at, first_seen_at_date, ref_price, ref_price_dt, ref_miles, ref_miles_dt, source, financing_options, leasing_options, trim_r, seller_name, seller_name_o, street, city, state, zip, latitude, longitude, dealer_id, status_date].hash
    end
