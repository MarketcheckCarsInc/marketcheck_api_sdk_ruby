...
module Marketcheck_api_sdk
  class PopularityItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'thumbs')
        self.thumbs = attributes[:'thumbs']
      end

      if attributes.has_key?(:'delta_percent')
        self.delta_percent = attributes[:'delta_percent']
      end
    ...
    def hash
      [text, left, right, difference, thumbs, delta_percent, color].hash
    end
