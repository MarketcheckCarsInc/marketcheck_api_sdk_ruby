...
module Marketcheck_api_sdk
  class ReviewComponents
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'user_rating')
        self.user_rating = attributes[:'user_rating']
      end

      if attributes.has_key?(:'actual_review')
        self.actual_review = attributes[:'actual_review']
      end
    end
    ...
    def hash
      [user_name, user_rating, actual_review].hash
    end
