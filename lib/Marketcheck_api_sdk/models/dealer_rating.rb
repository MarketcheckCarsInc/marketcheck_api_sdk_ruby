...
module Marketcheck_api_sdk
  class DealerRating
    ...
    attr_accessor :rating_components
    ...
    def self.swagger_types
      {
        ...
        :'rating_components' => :'Array<RatingComponents>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rating_components')
        if (value = attributes[:'rating_components']).is_a?(Array)
          self.rating_components = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rating_components == o.rating_components
    end
    ...
    def hash
      [name, street, city, state, zip, latitude, longitude, overall_rating, rating_components].hash
    end
